...
// import
// com.taein.springboot.example.domain.member.repository.MemberRepository;
...
// @Override
// public Order createOrder(Long memberId, Long itemId, DiscountPolicy
// discountPolicy) {
// Member member = memberRepository.findById(memberId).get();
// return new Order(member, new ArrayList<OrderedItem>(), memberId,
// discountPolicy);
// }
